    ...
    const renderBookInfoSection = () => {
        return (
            <View style={{ flex: 1 }}>
                ...
                <View
                    style={{
                        position: "absolute", top: 0, left: 0, right: 0, bottom: 0, backgroundColor: book.backgroundColor
                    }}
                >
                </View>
                {/* Navigation Header  */}
                <View
                    style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 60, alignItems: 'flex-end' }}
                >
                    <TouchableOpacity
                ...
                {/* Book cover  */}
                <View style={{ flex: 5, padding: SIZES.padding2, alignItems: 'center' }}>
                    <Image
                        source={book.bookCover}
                        resizeMode="contain"
                        style={{
                ...
                >
                    ...
                    <View style={{ flex: 1, alignItems: 'center' }}>
                        <Text style={{ ...FONTS.h4, color: COLORS.white }}>{book.rating}</Text>
                    ...
                    {/* Page  */}
                    <View style={{ flex: 1, alignItems: 'center', textAlign: 'center', paddingHorizontal: SIZES.radius }}>
                        <Text style={{ ...FONTS.h4, color: COLORS.white }}>{book.pageNo}</Text>
                        <Text style={{ ...FONTS.body4, color: COLORS.white }}>Number of line</Text>
                    </View>
                    {/* language */}
                    <LineDivider />

                    <View style={{ flex: 1, alignItems: 'center' }}>
                        <Text style={{ ...FONTS.h4, color: COLORS.white }}>{book.language}</Text>
